		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Add</span></a>
			...
			<?php
				...
				$req=$conf->connect()->prepare($conf->sqlall);
				$req->execute();	
				?>
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<td>
                    <a href="../../Controller/Modifier.php?id=<?php echo $donnees["id"];?> " class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="./../../Controller/Supprimer.php?id=<?php echo $donnees["id"];?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                </td>
					</tr>
					<?php
					}
